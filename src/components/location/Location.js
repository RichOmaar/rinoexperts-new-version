...
const Location = () => {
  return (
    <div className="container visit-us-main-container text-white-color">
      <div className="row">
        <div className="col-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 visit-us-container">
        ...
        <div className="col-12 col-xl-8 col-lg-8 col-md-8 col-sm-12 map-main-container row">
         <iframe

    ...
    <div className="container otoplastia-container py-3">
      <div className="row">
        <div className="col-12 text-center">
          <h2 className="font-bold">OTOPLASTIA</h2>
        </div>
        <div className="col-6 text-center otoplastia-img-container my-3">
          <img src={OtoplastiaImg} class="img-fluid otoplastia-img" alt="..." />
        </div>

...
import Procedure from "../../assets/img/servicios/lipopapada/lipopapada.png";
          ...
          <div className="col-12 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div className="text-center">
              ...
              <p>
                ...
                eliminar mediante aspiración el exceso de la grasa localizada
                del cuello remodelando la zona.
              </p>
            </div>

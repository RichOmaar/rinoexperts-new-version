...
const MedicalRecord = () => {
    ...
    function onChangeMedicine() {
        if(medicine === 1) {
            ...
            setMedicine(1);
            document.querySelector('#medicinesDescription').classList.remove('hidden');
    ...
    const medicalData = (e) => {
        ...
        console.log(JSON.stringify(allMedicalData));
        fetch ("http://localhost:8888/GitHub/rinoexperts-api/controllers/addAnswer.controller.php", {
        // fetch ("http://localhost:8888/rinoexperts-api/controllers/addAnswer.controller.php", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
            body: JSON.stringify(allMedicalData)
        })
    ...
    return (
        ...
        <div className="medical-record-container mt-3 pb-4">
            <div className="row">
